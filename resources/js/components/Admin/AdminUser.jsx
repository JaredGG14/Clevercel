...
function UserStore(props) {
    const endpoint = 'http://localhost/example-app/public/api/user_store'
    ...
    const store = async (e) => {
        ...
        await axios.post(endpoint,
            {
                rol: rol, nombre: nombre, apellido: apellido, email: email, password: password,
            ...
            {            
                ...
                navigate("/example-app/public/admin/admuser")               
            }).catch(error => {
                console.log("error");
...
function UserUpdate(props) {
    const endpoint = 'http://localhost/example-app/public/api/user_update'
...
function UserDestroy(props) {
    const navigate = useNavigate();
    const token = localStorage.getItem('token')
    const endpoint = 'http://localhost/example-app/public/api/user_delete'
    ...
    return (
        ...
        >
            <Modal.Header closeButton>
                <Modal.Title id="contained-modal-title-vcenter">
                    Seguro que quieres eliminar este usuario? {props.user.id}
                </Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <ModalDialog>
                    <button onClick={() => deleteUser(props.user.id)} className='btn btn-danger'>Delete</button>
                </ModalDialog>
            </Modal.Body>
            <Modal.Footer>
                <Button onClick={()=>window.location.reload()}>Listo</Button> 
...
function AdminUser() {
    ...
    const getAllUser = async () => {
        const response = await axios.get(`http://localhost/example-app/public/api/user_index`)
